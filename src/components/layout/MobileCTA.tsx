...
export function MobileCTA() {
  return (
    <div data-from="Смуга внизу" className="md:hidden fixed bottom-0 inset-x-0 z-40 bg-cream/96 backdrop-blur-md border-t border-[#d9d6d0] px-4 py-3 pb-[max(12px,env(safe-area-inset-bottom))]">
